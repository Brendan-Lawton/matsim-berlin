...
final class simWrapperDashboardCopy implements MATSimAppCommand {
...
//					sw.addDashboard(new ODTripDashboard());
	...
	public static void main(String[] args) {
		String[] arguments = {"--type=noise", "/home/brendan/remote-files/HW2/output/berlin-v6.3-10pct_policy"};

		new simWrapperDashboardCopy().execute(arguments);
	}
